                    ...
                    >
                      <div className="flex gap-x-4">
                        ...
                        <div className="min-w-0 flex-auto">
                          ...
                          <p className="mt-1 mr-2.5 truncate text-xs leading-5 text-gray-500">
                            {address.street}
                          </p>
                          <p className="mt-1 mr-3 truncate text-xs leading-5 text-gray-500">
                            {address.pincode}
                          </p>
                        </div>
                      </div>
                    ...
                    <li key={product.id} className="flex py-6">
                      ...
                      <div className="ml-4 flex flex-1 flex-col">
                        <div>
                          ...
                          <p className="flex flex-1 items-end justify-between text-sm">
                            {product.color}
                          </p>
                        </div>
